...
import com.smartscheduler_admin.adapters.Adapter_ProgramsActivityTabs;
...
public class ProgramsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Adapter_ProgramsActivityTabs myPagerAdapter = new Adapter_ProgramsActivityTabs(getSupportFragmentManager(), new Lifecycle() {
            @Override
        ...
        new TabLayoutMediator(tabLayout, viewPager, (tab, position) -> {
            if (position==0)
            {
                tab.setText("All Programs");
            }
            else if (position==1)
                tab.setText("Add New Program");
        }).attach();
    }
