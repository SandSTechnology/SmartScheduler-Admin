...
import com.smartscheduler_admin.adapters.Adapter_RoomsActivityTabs;
...
public class RoomsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Adapter_RoomsActivityTabs myPagerAdapter = new Adapter_RoomsActivityTabs(getSupportFragmentManager(), new Lifecycle() {
            @Override
        ...
        new TabLayoutMediator(tabLayout, viewPager, (tab, position) -> {
            if (position==0)
            {
                tab.setText("All Rooms");
            }
            else if (position==1)
                tab.setText("Add New Room");
        }).attach();
    }
