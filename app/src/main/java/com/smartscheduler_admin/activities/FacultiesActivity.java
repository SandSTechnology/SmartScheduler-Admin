...
import com.smartscheduler_admin.adapters.Adapter_FacultyActivityTabs;
...
public class FacultiesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Adapter_FacultyActivityTabs myPagerAdapter = new Adapter_FacultyActivityTabs(getSupportFragmentManager(), new Lifecycle() {
            @Override
        ...
        new TabLayoutMediator(tabLayout, viewPager, (tab, position) -> {
            if (position==0)
            {
                tab.setText("All Faculties");
            }
            else if (position==1)
                tab.setText("Add New Faculty");
        }).attach();
    }
